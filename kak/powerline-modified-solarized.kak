...
set-option -add global powerline_themes "solarized-light-modified"

define-command -hidden powerline-theme-solarized-light-modified %{ evaluate-commands %sh{
	base03='rgb:002b36'
	base02='rgb:073642'
	base01='rgb:586e75'
	base00='rgb:657b83'
    ...
    echo "
        ...
        declare-option -hidden str powerline_color00 ${base3}  # fg: bufname
        declare-option -hidden str powerline_color03 ${base00} # bg: bufname
        declare-option -hidden str powerline_color10 ${base3}  # fg: filetype
        declare-option -hidden str powerline_color11 ${base0}  # bg: filetype
        declare-option -hidden str powerline_color07 ${base3}  # fg: mode-info
        declare-option -hidden str powerline_color05 ${base3}  # fg: position
